...
export default function GuidedPractice({ questions, worldAccent, onComplete, playNarration }) {
  ...
  return (
    <div style={{ position: 'relative', width: '100%', maxWidth: 600, display: 'flex', flexDirection: 'column', gap: 10 }}>
      {/* HUD */}
        ...
        <AnimatePresence mode="wait">
          <motion.div key={index}
            ...
            <QuestionCard question={question} selected={selected} confirmed={confirmed}
              onSelect={setSelected} showHint worldAccent={worldAccent} playNarration={playNarration} />
          </motion.div>
        </AnimatePresence>
        {!confirmed && (
