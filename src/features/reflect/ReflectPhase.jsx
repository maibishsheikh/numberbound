...
const TAKEAWAYS = [
  { icon: '🔟', text: 'Every number can be broken into groups of ten, plus a few extra ones.' },
  { icon: '🔢', text: 'A numeral (like 42) and a number word (like forty-two) always mean the same thing.' },
  { icon: '➕', text: "The number before is one less; the number after is one more." },
  { icon: '📏', text: 'To put numbers in order, always find the smallest one first.' },
];

const CONFIDENCE_OPTIONS = [
  { emoji: '🌟', text: "I'm great at reading and writing numbers!" },
  { emoji: '👍', text: 'I can read most numbers!' },
    ...
    return (
      <div className="reflect-screen" style={{ justifyContent: 'center' }}>
        <div className="reflect-card glass-card" style={{ width: '100%', maxWidth: 520, textAlign: 'center' }}>
          ...
          <p style={{ fontWeight: 700, marginBottom: 16 }}>How confident do you feel about reading and writing numbers?</p>
      ...
      <div style={{ width: '100%', maxWidth: 560, display: 'flex', flexDirection: 'column', gap: 14, paddingBottom: 16 }}>
        ...
        <div className="reflect-card glass-card" style={{ textAlign: 'center' }}>
          ...
          <p style={{ color: 'var(--color-text-muted)', fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: '0.9rem', marginTop: 6 }}>
            {pct >= 80 ? "Outstanding! You're a Number Master! 🏆" : pct >= 60 ? "Well done! Keep practising! 💪" : "Review the key facts below 📚"}
          </p>
        </div>
        ...
        <div className="conversion-fact-box">
          <span className="rate-value">Tens + Ones = the number</span>
        ...
        <div className="reflect-badge glass-card">
          ...
          <div>
            ...
            <div className="reflect-badge-sub">Reading &amp; Writing Numbers 0-100</div>
          </div>
        </div>
