...
import TenFrameMission from './simulations/TenFrameMission.jsx';
import TeenNumberMission from './simulations/TeenNumberMission.jsx';
import Base10BlockMission from './simulations/Base10BlockMission.jsx';
import WordMatchMission from './simulations/WordMatchMission.jsx';
import Button from '../../components/Button.jsx';
import { simulationStationNarration } from '../../utils/narration.js';

const STATIONS = [
  { id: 0, icon: '🌟', title: 'Star Counting Mission', subtitle: 'Build numbers 0-10 on a ten-frame',        Component: TenFrameMission },
  { id: 1, icon: '🧸', title: 'Toy Box Mission',        subtitle: 'Build teen numbers as 1 ten + extra ones', Component: TeenNumberMission },
  { id: 2, icon: '🧱', title: 'Block Builder Mission',  subtitle: 'Build 2-digit numbers with base-10 blocks', Component: Base10BlockMission },
  { id: 3, icon: '📖', title: 'Word Match Mission',     subtitle: 'Match numerals to their number words',     Component: WordMatchMission },
];
    ...
    return (
      <div className="simulate-screen">
        ...
        >
          ...
          <p style={{ color: 'var(--color-text-muted)', marginBottom: 16, textAlign: 'center' }}>Total: {totalScore} / 12</p>
        ...
        >
          ...
          {completed.has(activeStation) ? (
            ...
            <div style={{ display: 'flex', flexDirection: 'column', flex: 1, minHeight: 0 }}>
              <StationComponent onComplete={handleStationComplete} playNarration={playNarration} />
            </div>
          )}
        </motion.div>
      </AnimatePresence>
